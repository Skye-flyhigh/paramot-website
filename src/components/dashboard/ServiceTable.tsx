...
import { getCompletedServices, getCustomerEquipment, getUpcomingServices } from "@/lib/mockData";
import Link from "next/link";

export default function ServiceTable({ customer }: { customer: Customer }) {
    ...
    return (
        <>
            {/* Stats Cards */}
            <StatsCards upcomingServices={upcomingServices} completedServices={completedServices} equipmentList={equipmentList}/>
          ...
          <div className="space-y-3">
            {Object.values(equipmentList).map((equipment, index) => (
              ...
              >
                ...
                <Link
                  href={`/dashboard/${equipment.serialNumber}`}
